    ...
    init: function () {
      ...
      this.el.addEventListener("pressedstarted", function(e) { 
        if (e.target == teleButton) {
          ...
          document.querySelector("#text2").setAttribute("value", handEl.components['hand-tracking-controls'].jointEls[0].keys(handEl.components['hand-tracking-controls'].jointEls[0]));
